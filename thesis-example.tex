...
% **************************************************
\newcommand{\thesisTitle}{Filtro de entrop\'iía aplicado a series de tiempo de mercados financieros}
...
\newcommand{\thesisFirstSupervisor}{Dr. Ra\'uúl Alejandro Hernández Montoya}
...
%\cleardoublepage
%
\input{content/motivacionacknowledgement} % INCLUDE: acknowledgement
\cleardoublepage
%
...
\input{content/contexto_teorico} % contexto teoricohapter-related-work} % INCLUDE: related work
\input{content/metodologiachapter-system}	% INCLUDE: system
\input{content/glosariochapter-concepts} % INCLUDE: concepts
