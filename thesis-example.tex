...
% **************************************************
\newcommand{\thesisTitle}{Filtro de entropía aplicado a series de tiempo de mercados financieros}
...
\newcommand{\thesisFirstSupervisor}{Dr. Raúl Alejandro Hernández Montoya}
...
\usepackage[spanish,english]{babel} % babel system, adjust the language of the content
